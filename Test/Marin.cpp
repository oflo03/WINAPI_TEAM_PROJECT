...
Marin::Marin(float x, float y) : Player(x, y)
{
	...
	animation[STATE_IDLE][BACK].resource.Load(L"resources/Marin_idle_back.png");
	animation[STATE_IDLE][BACK_RIGHT].resource.Load(L"resources/Marin_idle_back_right.png");
	animation[STATE_IDLE][BACK_LEFT].resource.Load(L"resources/Marin_idle_back_left.png");
	for (int i = 0; i < 6; i++) {
	...
	animation[STATE_RUN][FRONT].resource.Load(L"resources/Marin_run_front.png");
	animation[STATE_RUN][FRONT_RIGHT].resource.Load(L"resources/Marin_run_front_right.png");
	animation[STATE_RUN][FRONT_LEFT].resource.Load(L"resources/Marin_run_front_left.png");
	animation[STATE_RUN][BACK].resource.Load(L"resources/Marin_run_back.png");
	animation[STATE_RUN][BACK_RIGHT].resource.Load(L"resources/Marin_run_back_right.png");
	animation[STATE_RUN][BACK_LEFT].resource.Load(L"resources/Marin_run_back_left.png");
	for (int i = 0; i < 6; i++) {
	...
	animation[STATE_ROLL][FRONT].resource.Load(L"resources/Marin_roll_front.png");
	animation[STATE_ROLL][FRONT_RIGHT].resource.Load(L"resources/Marin_roll_front_right.png");
	animation[STATE_ROLL][FRONT_LEFT].resource.Load(L"resources/Marin_roll_front_left.png");
	animation[STATE_ROLL][BACK].resource.Load(L"resources/Marin_roll_back.png");
	animation[STATE_ROLL][BACK_RIGHT].resource.Load(L"resources/Marin_roll_back_right.png");
	animation[STATE_ROLL][BACK_LEFT].resource.Load(L"resources/Marin_roll_back_left.png");
	for (int i = 0; i < 6; i++) {
	...
	animation[STATE_DEAD][FRONT].resource.Load(L"resources/marin_dead.png");
	animation[STATE_DEAD][FRONT_RIGHT].resource.Load(L"resources/marin_dead.png");
	animation[STATE_DEAD][FRONT_LEFT].resource.Load(L"resources/marin_dead_left.png");
	animation[STATE_DEAD][BACK].resource.Load(L"resources/marin_dead.png");
...
void Marin::update()
{
	...
	else if (frame >= animation[curstate][direction].frame && curstate == STATE_DEAD) frame = 14;
