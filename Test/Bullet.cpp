...
void Bullet::init() {
	animation[BPISTOL].resource.Load(L"resources/Bullet_Pistol.png");
	animation[BPISTOL].frame = 4;
	animation[BPISTOL].velocity = 3;
	animation[BRIFLE].resource.Load(L"resources/Bullet_Rifle.png");
	animation[BRIFLE].frame = 4;
	animation[BRIFLE].velocity = 3;
	animation[BSHOTGUN].resource.Load(L"resources/Bullet_Shotgun.png");
	animation[BSHOTGUN].frame = 4;
	animation[BSHOTGUN].velocity = 3;
	animation[BROCKET].resource.Load(L"resources/Bullet_Rocket.png");
	animation[BROCKET].frame = 5;
	animation[BROCKET].velocity = 3;
	animation[BENEMY].resource.Load(L"resources/enemy_bullet3.png");
	animation[BENEMY].frame = 4;
	animation[BENEMY].velocity = 3;
	animation[BBOUNCE].resource.Load(L"resources/bounced_bullet.png");
	animation[BBOUNCE].frame = 4;
	animation[BBOUNCE].velocity = 3;
	animation[BOSSBULLET1].resource.Load(L"resources/boss_bullet1.png");
	animation[BOSSBULLET1].frame = 4;
	animation[BOSSBULLET1].velocity = 3;
	animation[BOSSBULLET2].resource.Load(L"resources/boss_bullet2.png");
	animation[BOSSBULLET2].frame = 1;
	animation[BOSSBULLET2].velocity = 0;
	animation[BOSSBULLET3].resource.Load(L"resources/boss_bullet3.png");
	animation[BOSSBULLET3].frame = 4;
	animation[BOSSBULLET3].velocity = 2;
	animation[BOUNCEDBOSSBULLET2].resource.Load(L"resources/boss_bullet2_bounced.png");
